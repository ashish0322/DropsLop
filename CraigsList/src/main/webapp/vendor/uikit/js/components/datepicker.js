    ...
    UI.component('datepicker', {
        ...
        init: function() {
            ...
            this.on("click focus", function(){
                //Default datepciker.js native code
                //if (active!==$this) $this.pick(this.value ? this.value:($this.options.minDate ? $this.options.minDate :''));
                
                //GWP modification
                if(!this.value){
                    // $this.pick($this.options.maxDate);
                    $this.pick(moment($this.options.maxDate, $this.options.format).subtract(1, 'days').format($this.options.format));
                }else{
